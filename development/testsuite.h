...
static void mavlink_test_am32_eeprom(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_am32_eeprom_t packet1, packet2;
        ...
        mav_array_memcpy(packet1.write_mask, packet_in.write_mask, sizeof(uint32_t)*7);
        mav_array_memcpy(packet1.data, packet_in.data, sizeof(uint8_t)*224);
    ...
    mavlink_msg_am32_eeprom_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_am32_eeprom_pack(system_id, component_id, &msg , packet1.index , packet1.mode , packet1.write_mask , packet1.length , packet1.data );
    mavlink_msg_am32_eeprom_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_am32_eeprom_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.index , packet1.mode , packet1.write_mask , packet1.length , packet1.data );
    mavlink_msg_am32_eeprom_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_am32_eeprom_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_am32_eeprom_send(MAVLINK_COMM_1 , packet1.index , packet1.mode , packet1.write_mask , packet1.length , packet1.data );
    mavlink_msg_am32_eeprom_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_am32_fw_update_start(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_am32_fw_update_start_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_am32_fw_update_start_pack(system_id, component_id, &msg , packet1.index , packet1.filepath );
    mavlink_msg_am32_fw_update_start_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_am32_fw_update_start_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.index , packet1.filepath );
    mavlink_msg_am32_fw_update_start_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_am32_fw_update_start_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_am32_fw_update_start_send(MAVLINK_COMM_1 , packet1.index , packet1.filepath );
    mavlink_msg_am32_fw_update_start_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
